...
export const ClinicInfoSection = () => {
  ...
  return (
    <section id="location" className="py-20 bg-gradient-to-b from-sky-100/70 via-blue-50/60 to-slate-100 border-b border-blue-200/60 relative overflow-hidden">
      {/* Background ambient glow */}
      <div className="absolute top-0 right-1/3 w-[500px] h-[500px] bg-teal-200/30 rounded-full blur-3xl pointer-events-none" />
      <div className="absolute bottom-0 left-1/3 w-[500px] h-[500px] bg-cyan-200/30 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 space-y-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm hover:shadow-xl hover:border-blue-300 transition-all duration-300 flex flex-col justify-between h-full group">
            <div>
              {/* Header */}
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 rounded-xl bg-[#0a184e] text-white flex items-center justify-center shrink-0 shadow-md shadow-blue-950/10 group-hover:scale-105 transition-transform">
              ...
              <div className="bg-slate-50/90 rounded-xl p-4 sm:p-5 border border-slate-100 my-6 space-y-3">
                ...
                <div className="flex items-start gap-2.5 text-slate-600 text-xs sm:text-sm font-medium border-t border-slate-200/60 pt-2.5">
          ...
          <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200/90 shadow-sm hover:shadow-xl hover:border-blue-300 transition-all duration-300 flex flex-col justify-between h-full group">
            <div>
              ...
              {/* Uniform Middle Content Box */}
              <div className="bg-slate-50/90 rounded-xl p-4 sm:p-5 border border-slate-100 my-6 space-y-3">
                <div className="flex items-center justify-between text-xs sm:text-sm font-medium pb-2 border-b border-slate-200/60">
            ...
            <div>
              ...
              <div className="bg-slate-50/90 rounded-xl p-4 sm:p-5 border border-slate-100 my-6 space-y-3">
                <div className="flex items-center justify-between text-xs sm:text-sm font-medium pb-2 border-b border-slate-200/60">
                  ...
                  <a href="tel:+251953437878" className="text-[#0a184e] font-extrabold hover:text-blue-600 transition-colors">
                    +251 953 4378 78
                  </a>
                </div>
                <div className="flex items-center justify-between text-xs sm:text-sm font-medium pb-2 border-b border-slate-200/60">
                  <span className="text-slate-600">{lang === 'am' ? 'ኢሜይል:' : 'Email:'}</span>
                  <a href="mailto:care@zivoradental.com" className="text-[#0a184e] font-bold hover:text-blue-600 transition-colors">
                ...
                <div className="flex items-center justify-between text-xs sm:text-sm font-medium pt-0.5">
                  ...
                  <div className="flex items-center gap-2">
                    <a
                      ...
                      className="p-1.5 rounded-lg bg-blue-100/80 hover:bg-[#0a184e] text-blue-900 hover:text-white transition-all border border-blue-200/60"
                    >
